...
const JournalPage = () => {
    ...
    return (
        <main className="relative min-h-screen bg-ivory text-warm-gray font-sans flex items-center justify-center p-4 sm:p-8 overflow-hidden">
            ...
            <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-start animate-fade-in-up">
                ...
                <div className="w-full space-y-8">
                    ...
                    <Button 
                        onClick={handleSave}
                        className="w-full text-lg bg-warm-gray text-ivory hover:bg-warm-gray/90 transition-all duration-300 shadow-xl shadow-blush-gold/30 !mt-12 h-14"
                    >
                        Save Entry
                    </Button>
                </div>
